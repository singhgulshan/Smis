...
import com.ctc.smis.dao.QualificationDetailsDAO;
 ...
 * @author Gulshan
 */
@WebServlet(name = "QualificationDetailController", urlPatterns = {"/QualificationDetailController"})
public class QualificationDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            QualificationDetailsDAO qualificationdao = new QualificationDetailsDAO();
