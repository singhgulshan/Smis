...
import com.ctc.smis.dao.UpdatePersonalDetailsDAO;
 ...
 * @author Gulshan
 */
@WebServlet(name = "UpdatePersonalDetailController", urlPatterns = {"/UpdatePersonalDetailController"})
public class UpdatePersonalDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UpdatePersonalDetailsDAO updatedao = new UpdatePersonalDetailsDAO();
            ...
            boolean status = updatedao.saveDetails(personalvo);
